...
def plot(model, n):
    ...
    plt.bar(np.arange(23), user1_energy, bottom=0)
    plt.bar(np.arange(23), user2_energy, bottom=np.array(user1_energy))
    plt.bar(np.arange(23), user3_energy, bottom=np.array(user1_energy) + np.array(user2_energy))
    plt.bar(np.arange(23), user4_energy, bottom=np.array(user1_energy) + np.array(user2_energy) + np.array(user3_energy))
    plt.bar(np.arange(23), user5_energy, bottom= np.array(user1_energy) + np.array(user2_energy) + np.array(user3_energy) + np.array(user4_energy))
    plt.legend(users)
